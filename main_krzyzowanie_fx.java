...
public class main_krzyzowanie_fx {
...
//                krzyzowanie_array_min_fx[i] = ocena_potomkow[i];
        ...
        double suma = 0;
        System.out.println("Populacja jednopunktowa");
        for (int i = 0; i < n; i++){
            System.out.print("\t");
            for (int j = 0; j<zakres_m; j++){
...
//                krzyzowanie_array_min_fx[i] = ocena_potomkow[i];
        ...
        suma = 0;
        System.out.println("Populacja dwupunktowa");
        for (int i = 0; i < n; i++){
            System.out.print("\t");
            for (int j = 0; j<zakres_m; j++){
                System.out.print(populacja_array_klon[i][j]+" ");
...
//        System.out.println("Łączenie w pary:");
        int numer_indeksu = 1;
        for (int i = 0; i<rozmiar_par/2; i++){
            int ilosc_punktow = r.nextInt(10);//zmienic na m
...
//                krzyzowanie_array_min_fx[i] = ocena_potomkow[i];
        ...
        suma = 0;
//        System.out.println("Populacja wielopunktowej");
        for (int i = 0; i < n; i++){
//            System.out.print("\t");
            for (int j = 0; j<zakres_m; j++){
//                System.out.print(populacja_array_klon[i][j]+" ");
...
//                krzyzowanie_array_min_fx[i] = ocena_potomkow[i];
        ...
        suma = 0;
//        System.out.println("Populacja równomiernej");
        for (int i = 0; i < n; i++){
//            System.out.print("\t");
            for (int j = 0; j<zakres_m; j++){
//                System.out.print(populacja_array_klon[i][j]+" ");
